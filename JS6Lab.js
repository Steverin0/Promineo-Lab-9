...
//before, arayOfNumbers was at the front and set equal to the sort method. arrayOfNumbers is a const 
//and should not be altered as it is constant.
//Another way we could handle this is by reassigning 'const' as 'let' since 'let' can be altered 
...
class Wallet {
  ...
  //money is not defined. this.money for the replacement
  removeMoney(amount) {
    this.money -= amount
  }
}
...
//problem was no return statements for the cases
